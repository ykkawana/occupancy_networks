            ...
            if rank == 0:
                ...
                if (backup_every > 0 and (it % backup_every) == 0) and it > 0:
                    ...
                    checkpoint_io.save('model_%d.pt' % it,
                                       ...
                                       loss_val_best=metric_val_best)
                # Run validation
                if validate_every > 0 and (it %
                                           validate_every) == 0 and it > 0:
                    ...
                    if model_selection_sign * (metric_val -
                                               metric_val_best) > 0:
...
if __name__ == '__main__':
    ...
    args.gpu_n = len(os.environ['CUDA_VISIBLE_DEVICES'].split(','))
    args.world_size = args.gpu_n

    os.environ['MASTER_ADDR'] = 'localhost'  #
    print(args.dist_port)
    os.environ['MASTER_PORT'] = str(args.dist_port)  #
    mp.spawn(train, nprocs=args.gpu_n, args=(args, ))
