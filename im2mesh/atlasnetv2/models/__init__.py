...
from im2mesh.atlasnetv2.models import encoder_latent, decoder
...
# Decoder dictionary
decoder_dict = {'atlasnetv2decoder': decoder.AtlasNetV2Decoder}
...
class AtlasNetV2(nn.Module):
    ...
    def forward(self, p, inputs, sample=True, **kwargs):
        ...
        output = self.decode(p, z, c, **kwargs)
        return output
    ...
    def decode(self, p, z, c, **kwargs):
        ...
        return self.decoder(p, z, c, **kwargs)
