...
attrs = configs['BSPNet_256']
config_path = attrs['config_path']
base_eval_dir = os.path.dirname(attrs['base_eval_dir'])
mesh_dir_path = os.path.join(
    base_eval_dir, 'generation_primitive_wise_watertight_20200507_023808')
...
def get_verts_faces_stats(inputs):
    ...
    for it in tqdm(indices):
        ...
        surface_verts = verts + all_mesh.vertex_normals * 1e-4
