...
from im2mesh.pnet.models import encoder_latent, decoder
...
class PeriodicShapeNetwork(nn.Module):
    ...
    def forward(self, p, inputs, sample=True, angles=None, **kwargs):
        ...
        output = self.decode(p, z, c, angles=angles, **kwargs)
        return output
